...
const gameState = {
    ...
    failedMissions: 0, // NEW: Counter for failed missions
    rank: {
        score: 0,
        level: "Rookie"
    },
...
function updateUI() {
    ...
    document.getElementById('failedMissionsCount').textContent = `${gameState.failedMissions}`; // NEW: Update failed missions count
